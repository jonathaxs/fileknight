...
const Map<String, String> _en = {
  ...
  'no_entries': 'Add at least one entry first.',
  ...
  'autostart_desc': 'Opens hidden in the tray at login',
  'tray_open': 'Open FileKnight',
  'tray_quit': 'Quit',
...
const Map<String, String> _ptBr = {
  ...
  'no_entries': 'Adicione ao menos uma entrada primeiro.',
  ...
  'theme_light': 'Claro',
  'theme_dark': 'Escuro',
  'startup_label': 'Início',
  'autostart_label': 'Iniciar com o sistema',
  'autostart_desc': 'Abre oculto na bandeja ao entrar',
  'tray_open': 'Abrir FileKnight',
  'tray_quit': 'Sair',
